...
var Toast = React.createClass({
	...
	render: function(){
		return (
			<div className={zn.react.classname('rt-toast', this.state.type, zn.react.isMobile()?'mobile':'')} data-active={this.state.active} >
				{
					/*
...
Toast.type = function (argv){
	...
	Toast._toast.setState({
		...
		window.setTimeout(()=>Toast.close(), _argv.delay || 3000);
	});
}
...
Toast.close = function (){
	Toast._toast.setState({ active: false })
}
