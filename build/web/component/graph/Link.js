...
module.exports = React.createClass({
  ...
  */
		return React.createElement(
			'svg',
			{ className: 'zr-graph-link', version: '1.1', xmlns: 'http://www.w3.org/2000/svg', style: this.state.svgStyle },
			React.createElement(
				'defs',
				null,
				React.createElement(
					'marker',
					{ id: 'Triangle', markerWidth: '20', markerHeight: '20', refX: '0', refY: '4', orient: 'auto', markerUnits: 'strokeWidth', viewBox: '0 0 50 50' },
					React.createElement('path', { d: 'M0,0 L0,6 L9,3 z', fill: '#f00' })
				)
			),
			React.createElement('line', { className: 'line', markerStart: 'url(#Triangle)', x1: this.state.x1, y1: this.state.y1, x2: this.state.x2, y2: this.state.y2, style: this.state.lineStyle })
		);
	}
});