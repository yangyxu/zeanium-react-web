...
module.exports = React.createClass({
	...
	render: function render() {
		...
		return React.createElement(
			'div',
			{ className: zn.react.classname("zr-rich-selector", this.props.className), 'data-active': this.state.active },
			React.createElement(
				'div',
				{ className: 'display-view', onClick: function onClick() {
						return _this.setState({ active: !_this.state.active });
					} },
				React.createElement(
					'span',
					{ className: 'text' },
