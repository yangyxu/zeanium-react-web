...
module.exports = React.createClass({
	...
	render: function render() {
		return React.createElement(
			Dropdown,
			_extends({}, this.props, { popoverRender: this.__popoverRender, popoverWidth: '100%', popoverHeight: 200, className: zn.react.classname("zr-dropdown-selector", this.props.className) }),
			React.createElement(
				'div',
