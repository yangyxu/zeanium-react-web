...
module.exports = React.createClass({
	...
	render: function render() {
		return React.createElement(
			'div',
			{ className: zn.react.classname('zr-multi-input', this.props.className), style: this.props.style },
			(this.props.data || []).map(function (item, index) {
				return React.createElement('input', { ref: index, key: index, placeholder: item, type: 'text' });
			})
		);
	}
});