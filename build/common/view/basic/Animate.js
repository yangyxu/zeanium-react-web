...
module.exports = React.createClass({
	...
	render: function render() {
		return React.createElement(
			'div',
			{ className: zn.react.classname("rt-animate zn-page", this.state.active || this.state.animating ? 'zn-page-current' : '', !!this.props.onTop && this.state.animation ? 'zn-page-ontop' : '', this.props.className, this.state.animation) },
			this.props.children
		);
	}
});